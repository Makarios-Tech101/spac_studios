        ...
        <div class="our-services-gallery-title">
         ...
         <div class="individual-services-banner-container">
            <div class="individual-services-banner-content">
               <p>
                Children grow up so fast: preserve 
                their innocence, joy, and curiosity 
                with professional child photography. 
                We create a warm, fun, and engaging
                 experience to capture their most 
                 natural expressions.
               </p>
               <p id="second-paragraph">
                    We ensure a stress-free session, 
                    allowing kids to be themselves 
                    while we capture their unique 
                    personalities.
               </p>
