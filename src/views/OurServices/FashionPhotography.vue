        ...
        <div class="our-services-gallery-title">
         ...
         <div class="individual-services-banner-container">
            <div class="individual-services-banner-content">
               <p>
                 Step into the world of high-end photography 
                 with our professional fashion shoots. 
                 Whether you're a model, designer, or brand, 
                 we provide stunning visuals that elevate 
                 your portfolio or campaign. Fashion Photography can include:
                 Editorial and commercial shoots, Model portfolio development, 
                 Runway and brand campaigns.
               </p>
               <p id="second-paragraph">
                    From concept development to styling and execution,
