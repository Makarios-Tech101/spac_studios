        ...
        <div class="our-services-gallery-title">
         ...
         <div class="individual-services-banner-container">
            <div class="individual-services-banner-content">
               <p>
                    Corporate events are an essential part
                    of business branding, networking, 
                    and marketing. We provide professional 
                    photography that captures the energy,
                     key moments, and brand essence of your 
                    corporate gatherings. We cover conferences and seminars,
                    Networking Events, Product Launches, Award Ceremonies.
               </p>
               <p id="second-paragraph">
                 High-quality event photography enhances your brand's 
                 professional image and helps you make an impact.
               </p>
