        ...
        <div class="our-services-gallery-title">
         ...
         <div class="individual-services-banner-container">
            <div class="individual-services-banner-content">
               <p>
                 Birthdays are milestones worth 
                 celebrating! Whether it's a 
                 fun-filled kids’ party or a 
                 sophisticated adult birthday shoot, 
                 we create stunning images that capture 
                 the excitement and happiness of the day.
               </p>
               <p id="second-paragraph">
                    Let us turn your birthday moments into lifelong memories.
               </p>
